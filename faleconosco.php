...
if(isset($_POST["btnSalvar"]))
{
    ...
    if($_POST["btnSalvar"]=='salvar')
    {
        ...
        $sql="insert into tbl_fale_conosco (nome,telefone,celular,email,sexo,sugestoes,informacoesProdutos,profissao,linkFacebook)
            values('".$nome."','".$telefone."','".$celular."','".$email."',
                   '".$sexo."','".$sugestoes."','".$link_facebook."','".$produto."','".$profissao."');";
        mysql_query($sql);
            ...
            <form method="post" action="faleconosco.php">
                <table class="tabela" height="500">
                    ...
                    <tr>
                        ...
                        <td class="coluna2">
                            <input type="text" name="txtLink" value="" size="30px">
                        </td>
                    </tr>
                    <tr>
                        <td class="coluna1">
                    ...
                    <tr>
                        ...
                        <td class="coluna2">
                            <input placeholder="" type="text" name="txtProdutos" value="" size="30px"  title="Formato inválido!" onkeypress="return validar(event,'caracter')">
                        </td>
                    </tr>
                    <tr>
                        <td class="coluna1">
                        ...
                        <td class="coluna2">
                            <input placeholder="" type="text" name="txtProf" value="" size="30px"  title="Formato inválido!" onkeypress="return validar(event,'caracter')">
                        </td>
                    </tr>
                    <tr>
                        <td class="coluna1">
                        ...
                        <td class="coluna2">
                            <input placeholder="" type="text" name="txtLink" value="" size="30px"  title="Formato inválido!" onkeypress="return validar(event,'caracter')">
                        </td>
                    </tr>
                    <tr>
