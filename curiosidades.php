            ...
            <main id="main">
                ...
                <section id="conteudo_curiosidades">
                    ...
                    <div class="curiosidades">
                        <div class="img_curiosidades_esquerda">
                                <img src="<?php echo($rs['imagem'])?>">
                        </div>
                        <div class="texto_curiosidade">

                                <?php echo($rsContatos['introdução'])?>
                    ...
                    <div class="curiosidades">
                        <div class="texto_curiosidade_esquerda">
                                <?php echo($rsContatos['introdução'])?>
                        </div>
                        <div class="img_curiosidades">
                            <img src="<?php echo($rsContatos['imagem'])?>">
                        </div>
                    </div>
                    <?php 
                                    }
